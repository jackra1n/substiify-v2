...
class Help(commands.MinimalHelpCommand):
	...
	async def send_group_help(self, group):
		...
		embed.set_footer(
			text=f"This command has subcommands. Check their help page with `{self.context.clean_prefix}help {command_chain}{group.name} <subcommand>`"
		)
	...
	def create_command_help_embed(self, command):
		...
		embed = Embed(title=command_name, color=constants.SECONDARY_COLOR)
